...
import cn.datacast.优先级队列.IndexMinPriorityQueue;
...
public class DijkstraSP {
    ...
    public static void main(String[] args) throws Exception{
        //创建一副加权有向图
        BufferedReader br = new BufferedReader(new InputStreamReader(DijkstraSP.class.getClassLoader().getResourceAsStream("cn/datacast/有向图/min_create_tree_test.txt")));
